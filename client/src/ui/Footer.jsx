	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				<h2 className="text-4xl text-center md:text-left mb-4">Mytalorzone</h2>
				<p className="text-justify text-gray-700">Mytalorzone By Sahiba</p>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					...
					<li className="flex items-center">
						...
						<a href="mailto:ranadaksh205@gmail.com" target="_blank">
							ranadaksh205@gmail.com
						</a>
					</li>
					<li className="flex items-center">
